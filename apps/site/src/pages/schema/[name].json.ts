...
const schemas: Record<string, unknown> = { 'orbit-plan': plan, 'project-snapshot': snapshot, reconciliation, 'execution-slice': slice };
...
export const GET: APIRoute = ({ params }) => {
  ...
  return value ? new Response(JSON.stringify(value, null, 2), { headers: { 'Content-Type': 'application/schema+json; charset=utf-8' } }) : new Response('Not found', { status: 404 });
};
