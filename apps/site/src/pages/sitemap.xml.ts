...
export const GET: APIRoute = () => {
  ...
  const routes = key === 'agentsdlc' ? ['', '/standards', '/interoperability', '/governance', '/implementations', '/contribute'] : key === 'orbit' ? ['', '/concepts', '/quick-start', '/specification', '/schemas', '/reconciliation', '/execution-slices', '/examples', '/conformance', '/changelog'] : ['', '/quick-start', '/specification', '/schema', '/examples', '/integrations', '/conformance', '/related-standards', '/changelog'];
